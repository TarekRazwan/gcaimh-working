    ...
    <Box sx={{ 
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          {/* Chart header row with collapse toggle */}
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: chartCollapsed ? 0 : 0.5 }}>
            <Typography sx={{ fontSize: '11px', fontWeight: 600, color: '#5f6368', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
              Engagement &amp; Alliance
            </Typography>
            <IconButton size="small" onClick={() => setChartCollapsed(prev => !prev)} sx={{ p: 0.25 }}>
              {chartCollapsed ? <ExpandMore sx={{ fontSize: 18, color: '#5f6368' }} /> : <ExpandLess sx={{ fontSize: 18, color: '#5f6368' }} />}
            </IconButton>
          </Box>
          ...
          <Box sx={{ 
            ...
            <Box sx={{
              ...
              <Box sx={{ minWidth: 0 }}>
                ...
                <Typography sx={{ fontWeight: 600, fontSize: '14px', color: '#1f1f1f', textTransform: 'capitalize', lineHeight: 1.3, whiteSpace: 'nowrap' }}>
            ...
            <Box sx={{
              ...
              <Box sx={{ minWidth: 0 }}>
                ...
                <Typography sx={{ fontWeight: 600, fontSize: '14px', color: '#1f1f1f', lineHeight: 1.3, whiteSpace: 'nowrap' }}>
